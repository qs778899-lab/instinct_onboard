...
bool unitree_hg__msg__hand_state__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  ...
  {  // press_sensor_state
    ...
    if (!unitree_hg__msg__press_sensor_state__convert_from_py(field, &ros_message->press_sensor_state)) {
      Py_DECREF(field);
      return false;
    }
    Py_DECREF(field);
...
PyObject * unitree_hg__msg__hand_state__convert_to_py(void * raw_ros_message)
{
  ...
  {  // press_sensor_state
    PyObject * field = NULL;
    field = unitree_hg__msg__press_sensor_state__convert_to_py(&ros_message->press_sensor_state);
    if (!field) {
      return NULL;
    }
    {
