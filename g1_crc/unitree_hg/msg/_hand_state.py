...
class HandState(metaclass=Metaclass_HandState):
    ...
    _fields_and_field_types = {
        ...
        'press_sensor_state': 'unitree_hg/PressSensorState',
        'power_v': 'float',
        'power_a': 'float',
        'reserve': 'uint32[2]',
    }
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.NamespacedType(['unitree_hg', 'msg'], 'PressSensorState'),  # noqa: E501
    ...
    def __init__(self, **kwargs):
        ...
        from unitree_hg.msg import PressSensorState
        self.press_sensor_state = kwargs.get('press_sensor_state', PressSensorState())
    ...
    def press_sensor_state(self, value):
        if __debug__:
            from unitree_hg.msg import PressSensorState
            assert \
                isinstance(value, PressSensorState), \
                "The 'press_sensor_state' field must be a sub message of type 'PressSensorState'"
